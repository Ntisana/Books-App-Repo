...
public class ApiUtil {
    private ApiUtil() {}                                                                                // Good idea to remove the base constructor

    public static final String BASE_API_URL = "https://www.googleapis.com/books/v1/volumes";
    private static final String QUERY_PARAMETER_KEY = "q";
    public static final String KEY = "key";
    public static final String API_KEY = "AIzaSyAWS9NDr5mhEsPAYE7_827QLGoRL-rKkfc";
    ...
    public static String getJson(URL url) throws IOException {                                         // Connecting to the API
        ...
        try {
            ...
            scanner.useDelimiter("\\A");                                                              // Regular exception pattern
